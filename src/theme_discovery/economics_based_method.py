...
def economicsCitationLdaSummary(ldaFilePath):
    ...
    topicSummary = getTopicSummary(hd, eidToId, idToEid, ldaInstance, topDocCnt=5, topTokCnt=20)
...
if __name__ == '__main__':
    ...
    economicsCitationLdaSummary('E:\\study\\PycharmProjects\\lda_project\\citation_lda\\data\\economics_citation_lda_500_546205_546205_1e-06_1e-06_timeCtrl_8_8.lda')
