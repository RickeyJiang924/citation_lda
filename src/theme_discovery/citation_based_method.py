...
#                                   '/home/xwang95/result/pubmed_citation_lda/pubmed_citation_lda_100_145317_145317_0.001_0.001_timeCtrl_30_45.lda_summary')
    ...
    ldaFilePath2 = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_500_145317_145317_0.001_0.001_timeCtrl_30_45.lda');
    ldaFilePath2 = ldaFilePath2.replace('\\', '/')
