...
if __name__ == '__main__':
    cit_matrix_file_path = '/Users/loohaze/Documents/GitHub/citation_lda/data/economics_citation_lda_50_546205_546205_1e-06_1e-06_timeCtrl_20_20.lda_citMatrix'
    topic_summary_file_path = '/Users/loohaze/Documents/GitHub/citation_lda/data/economics_citation_lda_50_546205_546205_1e-06_1e-06_timeCtrl_20_20.lda_summary'
    cit_matrix = theme_discovery.economics_based_method.readCitMatrixSummary(cit_matrix_file_path)
    topic_summary_dict = theme_discovery.economics_based_method.readTopicSummary(topic_summary_file_path)

    eco = corpus.economics.getEconomicsCorpus()
    getTopicCitationProb(cit_matrix, topic_summary_dict, eco)

    edgeWeightThreshold = 0.02
    dumpGraphFile(cit_matrix_file_path, topic_summary_file_path, edgeWeightThreshold)
    dumpVenRankingFile(topic_summary_file_path)

    printVenEntropy(topic_summary_file_path)
