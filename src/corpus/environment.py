...
class Environment(object):
    ...
    def readMetaDataFile(self):
        ...
        print('[Environment] MetaData {0} entries (#Eid)'.format(cnt))
        return
    ...
    def readCitationFile(self):
        ...
        for Eid in citDict:
            if Eid in self.docs:
                ...
                cnt += 1
        print('[Environment] citations {0} entries (#citing paper)'.format(cnt))
        print('[Environment] citing docs {0} (#edges)'.format(len(self.citeMetaGraph)))
...
def reportCiteMetaGraph(citeMetaGraph):
    ...
    # print('[Environment Citing Meta Graph]: report:')
...
def generateMetaFile(sourceFilePath, metaFilePath):
    ...
    while 1:
        ...
        cnt += 1
    metaFile.close()
    print('[Environment-metadata] processing {0} docs'.format(cnt))
    print('[Environment-metadata] Exception Doc: {0}'.format(exceptCnt))
    return
...
# API
# ===============================================================================
# def getEnvironmentCorpus(metaDataFilePath='E:\\bigdata\\PycharmWorkspace\\lda_project\\citation_lda\\data\\environment_metadata_file.txt',
#                     citFilePath='E:\\bigdata\\PycharmWorkspace\\lda_project\\citation_lda\\data\\environment_citation_file.txt'):
#     return Environment(metaDataFilePath, citFilePath)

def getEnvironmentCorpus(metaDataFilePath='E:\\study\\PycharmProjects\\lda_project\\citation_lda\\data\\environment_data\\environment_metadata_file.txt',
                    citFilePath='E:\\study\\PycharmProjects\\lda_project\\citation_lda\\data\\environment_data\\environment_citation_file.txt'):
    return Environment(metaDataFilePath, citFilePath)
...
if __name__ == '__main__':
    ...
    # ===========================================================================
    #    generateMetaFile(EnvironmentFolderPathLst, metaDataFilePath)

    # ===========================================================================
    # Generate Citation File
    # ===========================================================================
    #    generateCitFile(readMetaFile(metaDataFilePath), EnvironmentCitContextFilePathLst, citFilePath)

    # ===========================================================================
    # Generate Abstract File
    # ===========================================================================
    #    generateAbstractDataset(EnvironmentFolderPathLst)
    #    generateAbstractFile(metaDataFilePath, citFilePath, absFilePath)

    # ===========================================================================
    # Environment Corpus
    # ===========================================================================
    # his = Environment('E:\\bigdata\\PycharmWorkspace\\lda_project\\citation_lda\\data\\environment_metadata_file.txt',
    #                     'E:\\bigdata\\PycharmWorkspace\\lda_project\\citation_lda\\data\\environment_citation_file.txt')

    # ===========================================================================
    # API Example
    # ===========================================================================
    ed = getEnvironmentCorpus()
