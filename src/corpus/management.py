...
class Management(object):
    ...
    def readMetaDataFile(self):
        ...
        print('[Management] MetaData {0} entries (#Eid)'.format(cnt))
        return
    ...
    def readCitationFile(self):
        ...
        for Eid in citDict:
            if Eid in self.docs:
                ...
                cnt += 1
        print('[Management] citations {0} entries (#citing paper)'.format(cnt))
        print('[Management] citing docs {0} (#edges)'.format(len(self.citeMetaGraph)))
...
def reportCiteMetaGraph(citeMetaGraph):
    ...
    # print('[Management Citing Meta Graph]: report:')
...
def generateMetaFile(sourceFilePath, metaFilePath):
    ...
    while 1:
        ...
        cnt += 1
    metaFile.close()
    print('[Management-metadata] processing {0} docs'.format(cnt))
    print('[Management-metadata] Exception Doc: {0}'.format(exceptCnt))
    return
...
# API
# ===============================================================================
# def getManagementCorpus(metaDataFilePath='E:\\bigdata\\PycharmWorkspace\\lda_project\\citation_lda\\data\\management_metadata_file.txt',
#                     citFilePath='E:\\bigdata\\PycharmWorkspace\\lda_project\\citation_lda\\data\\management_citation_file.txt'):
#     return Management(metaDataFilePath, citFilePath)

def getManagementCorpus(metaDataFilePath='E:\\study\\PycharmProjects\\lda_project\\citation_lda\\data\\management_data\\management_metadata_file.txt',
                    citFilePath='E:\\study\\PycharmProjects\\lda_project\\citation_lda\\data\\management_data\\management_citation_file.txt'):
    return Management(metaDataFilePath, citFilePath)
...
if __name__ == '__main__':
    ...
    # ===========================================================================
    #    generateMetaFile(ManagementFolderPathLst, metaDataFilePath)

    # ===========================================================================
    # Generate Citation File
    # ===========================================================================
    #    generateCitFile(readMetaFile(metaDataFilePath), ManagementCitContextFilePathLst, citFilePath)

    # ===========================================================================
    # Generate Abstract File
    # ===========================================================================
    #    generateAbstractDataset(ManagementFolderPathLst)
    #    generateAbstractFile(metaDataFilePath, citFilePath, absFilePath)

    # ===========================================================================
    # Management Corpus
    # ===========================================================================
    # his = Management('E:\\bigdata\\PycharmWorkspace\\lda_project\\citation_lda\\data\\management_metadata_file.txt',
    #                     'E:\\bigdata\\PycharmWorkspace\\lda_project\\citation_lda\\data\\management_citation_file.txt')
