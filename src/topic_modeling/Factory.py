...
if __name__ == '__main__':
    ...
    factory.readCitationFile('E:\\study\\PycharmProjects\\lda_project\\citation_lda\\data\\test_citation_file.txt')
    # factory.readCitationFile('E:\\bigdata\\PycharmWorkspace\\lda_project\\citation_lda\\data\\test_citation_file.txt')
    metadata_obj = factory.readMetadataFile('E:\\study\\PycharmProjects\\lda_project\\citation_lda\\data\\test_metadata_file.txt')
    ...
    dump(p_theta, p_phi, topic_weights, d, k,
         'E:\\study\\PycharmProjects\\lda_project\\citation_lda\\data\\test_theta_file.txt',
         'E:\\study\\PycharmProjects\\lda_project\\citation_lda\\data\\test_phi_file.txt',
         'E:\\study\\PycharmProjects\\lda_project\\citation_lda\\data\\test_topic_weight_file.txt',
         factory.corpus)
    # dump(p_theta, p_phi, topic_weights, d, k,
